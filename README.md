...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/drf-spectacular-sidecar-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/drf-spectacular-sidecar-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add drf-spectacular-sidecar
# for installing globally
pixi global install drf-spectacular-sidecar
```
...
It is possible to list all of the versions of `drf-spectacular-sidecar` available on your platform:
...
```
pixi search drf-spectacular-sidecar --channel conda-forge
```
